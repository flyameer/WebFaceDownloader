...
namespace WebFaceDownloader
{
    ...
    public interface IProgressCallback
	{
        ...
        void WrittingBuffer1();

        void WrittingBuffer2();

        void SetImage(string img_path,int tmp,int frame_id,int year,int month,int date,int hour,int minute,int sec);

        void SetMaxTempUpdate(int frame_id, int tmp);

        void SetImageBigPIC(string img_path);
        void SetImageTmpPIC(string img_path);
    }
}
